...
<head>
    ...
    <!-- Favicon for the browser icon -->
    <link rel="icon" href="{{ asset('assets/images/grocery_logo.png') }}" type="image/png">
                    ...
                    <div class="box-logo">
                        <a href="" id="site-logo-inner">
                            <img class="" id="logo_header_1" alt=""
                                src="{{ asset('assets/images/grocery_logo.png') }}"
                                data-light="{{ asset('assets/images/grocery_logo.png') }}"
                                data-dark="{{ asset('images/logo/logo.png') }}" width="100">
                        </a>
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('advertisements.create') }}" class="">
                                                <div class="text">Add Advertise</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('advertisements.index') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('update-quantity') }}">
                                                <div class="text">Add Stock</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('subtract-quantity.form') }}">
                                                <div class="text">Substract Stock</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{route('orders.preparing')}}" class="">
                                                <div class="text">Order Preparing</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('orders.delivering')}}" class="">
                                                <div class="text">Order Delivering</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('orders.delivered')}}" class="">
                                                <div class="text">Order Delivered</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('orders.cancelled')}}" class="">
                                                <div class="text">Order Cancelled</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{route('payment_methods.create')}}" class="">
                                                <div class="text">New payment method</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('addresses.index')}}" class="">
                                                <div class="text">User Address</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('provinces.index') }}" class="">
                                                <div class="text">Province</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('districts.index')}}" class="">
                                                <div class="text">District</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('communes.index')}}" class="">
                                                <div class="text">Commune</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.change_password')}}" class="">
                ...
                <div class="section-content-right">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end has-content"
                                                    ...
                                                    <li>
                                                        <div class="message-item item-2">
                                                            ...
                                                            <div>
                                                                <div class="body-title-2">Account has been verified
                                                                </div>
                                                    ...
                                                    <li>
                                                        <div class="message-item item-3">
                                                            ...
                                                            <div>
                                                                <div class="body-title-2">Order shipped successfully
                                                                </div>
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                                    ...
                                                    <span class="header-user wg-user">
                                                        <span class="image">
                                                            <img src="{{ Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('images/avatar/user-1.png') }}"
                                                                alt="Profile Photo">
                                                        </span>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end has-content"
                                                    ...
                                                    <li>
                                                        ...
                                                        {{-- <form action="{{ route('logout') }}" method="POST" class="user-item">
                                                            ...
                                                            <button type="submit" class="body-title-2">Logout</button>
                                                        </form> --}}
                                                        <a href="#"
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 Kheav Sokhan</div>
                        </div>
                    </div>
